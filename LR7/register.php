...
if(isset($_POST["register"])) {
    ...
    if ($password == $accepted_password)
    {
        if ($numrows == 0)
        {
            ...
            if ($result)
            {
                mail($user_address, 'Успешная регистрация', 'Регистрация выполнена успешно, если вы не совершали данного действия свяжитесь с администратор в ответном сообщении', 'From: artem.kotegov@mail.ru');
